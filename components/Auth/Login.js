            ...
            <Grid item xs={12}>
              <div className={classes.cardBody}>
                <Paper className={classes.cardBodyLogin} variant="elevation">
                  ...
                  <h6 className={classes.loginWithSocialMedia}>Login with Email</h6>
                  ...
                  <h6 className={classes.forgetPassword} onClick={handleClickOpen}>Forget Password?</h6>
...
export default withRouter(connect(mapStateToProps, { getLoginData, getRegisterData, postDataToApi })(
  Login
));
