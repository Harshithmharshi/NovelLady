                    ...
                    <div className={classes.cardBody}>
                        ...
                        <Paper className={classes.cardBodyReset} variant="elevation">
                            <h3 className={classes.ResetHeader}>
                                <i className="fas fa-sign-in-alt"></i> إعادة تعيين كلمة المرور
                            </h3>
                            {OTPStatus.status ? <>
                                ...
                                <div style={{ marginTop: '5.5%' }}>
                                    <p style={{ fontFamily: "Cairo, sans-serif",fontWeight:'400'}}>انتهت صلاحية رابط إعادة التعيين هذا. يرجى المحاولة مرة أخرى نسيت كلمة المرور</p>
                                    <Button
                                        variant="contained"
                                        size="medium"
                                        style={{ marginBottom: '5%', marginTop: '3%' }}
