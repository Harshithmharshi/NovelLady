    ...
    return (
        <div style={{float:'left'}}>
            <Dialog fullWidth={true} maxWidth={'sm'} open={open} onClose={handleClose}>
                <DialogTitle >هل نسيت كلمة المرور</DialogTitle>
                {!message   ? <>
                    <DialogContent style={{ padding: '20px' }} >
                        <TextField
                            autoFocus
                            id="email"
                            label="عنوان البريد الإلكتروني المسجل"
                            type="email"
                            name="email"
                            fullWidth
                            variant="outlined"
                    ...
                    <>
                        ...
                        <DialogContent>
                            {forgotPassword.isLoading ? <CircularProgress color="secondary" /> : <p style={{ fontFamily: "Cairo, sans-serif",fontWeight:'400'}}>{forgotPasswordStatus}</p>}
